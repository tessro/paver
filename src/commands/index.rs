...
fn generate_index(docs: &[DocInfo], custom_content: Option<&str>) -> Result<String> {
    ...
    let type_order = [DocType::Component, DocType::Runbook, DocType::Adr, DocType::Other];
    ...
    output.push_str("---\n");
    output.push_str(&format!("*Generated by paver. Last updated: {}*\n", timestamp));
...
mod tests {
    ...
    fn test_detect_doc_type_from_content() {
        ...
        assert_eq!(detect_doc_type(&path, component_content), DocType::Component);
    }
